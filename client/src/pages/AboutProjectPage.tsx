          ...
          {activeTab === 'github' && (
            <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-black dark:text-white">
                        jianbaobao/GameServerManager
                      </h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">公开仓库</p>
                    </div>
                  </div>
                  <a
                    href="https://github.com/jianbaobao/GameServerManager"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a
                  href="https://github.com/jianbaobao/GameServerManager/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://github.com/jianbaobao/GameServerManager/releases"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
                >
